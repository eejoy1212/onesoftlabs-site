...
const Hero = () => {
          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4">
              ...
              >
                ...
                아이디어를 실현하는 단 하나의 선택<br/>원소프트.
                </h1>
                {/* <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                원소프트는 창의적인 아이디어를 현실로 만드는 기술 파트너입니다.  
                웹과 앱 개발을 전문으로 하며, 효율적이고 완성도 높은 디지털 솔루션을 제공합니다.  
                빠른 개발과 깔끔한 UI/UX 구현을 바탕으로, 스타트업과 기업이 성공적인 서비스를 출시할 수 있도록 함께합니다.
                </p> */}
                ...
                <div>
                  ...
                  원소프트는 다양한 언어와 프레임워크를 자유롭게 활용하는 개발사입니다.
                  </p>
  ...
  width={700} // 기존보다 작게 조정
  height={250} // 비율 유지하면서 줄이기
/>
